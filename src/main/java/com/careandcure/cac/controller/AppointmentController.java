...
public class AppointmentController {
    ...
    public ResponseEntity<List<Appointment>> getAppointmentsForDoctor(@PathVariable int doctorId) {
    ...
    public ResponseEntity<Appointment> createAppointment(@PathVariable int patientId, @RequestBody Appointment appointment) {
    ...
    public ResponseEntity<Appointment> updateAppointment(@PathVariable int id, @RequestBody Appointment updatedAppointment) {
        System.out.println(updatedAppointment.toString()+"fffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff");
    ...
    public ResponseEntity<String> cancelAppointment(@PathVariable int id, @RequestParam String reason) {
